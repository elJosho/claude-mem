...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=_?`${_[1].split("/").pop()}:${_[2]}`:"unknown",l={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,l,n),o}},u=new J;var xt={};function yt(){return typeof __dirname<"u"?__dirname:(0,f.dirname)((0,ge.fileURLToPath)(xt.url))}var vt=yt();function Ut(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,f.join)((0,z.homedir)(),".claude-mem"),e=(0,f.join)(r,"settings.json");try{if((0,F.existsSync)(e)){let{readFileSync:t}=require("fs"),s=JSON.parse(t(e,"utf-8")),n=s.env??s;if(n.CLAUDE_MEM_DATA_DIR)return n.CLAUDE_MEM_DATA_DIR}}catch{}return r}var N=Ut(),L=process.env.CLAUDE_CONFIG_DIR||(0,f.join)((0,z.homedir)(),".claude"),ts=(0,f.join)(L,"plugins","marketplaces","thedotmack"),ss=(0,f.join)(N,"archives"),rs=(0,f.join)(N,"logs"),ns=(0,f.join)(N,"trash"),os=(0,f.join)(N,"backups"),is=(0,f.join)(N,"modes"),as=(0,f.join)(N,"settings.json"),Te=(0,f.join)(N,"claude-mem.db"),ds=(0,f.join)(N,"vector-db"),cs=(0,f.join)(N,"observer-sessions"),fe="observer-sessions",_s=(0,f.join)(L,"settings.json"),us=(0,f.join)(L,"commands"),ms=(0,f.join)(L,"CLAUDE.md");function Se(r){(0,F.mkdirSync)(r,{recursive:!0})}function be(){return(0,f.join)(vt,"..")}var he=require("crypto");var kt=3e4;function P(r,e,t){return(0,he.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function X(r,e,t){let s=t-kt;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}function Q(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var h="claude";function $t(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function D(r){if(!r)return h;let e=$t(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("opencode")?"opencode":e.includes("claude")?"claude":e:h}function Oe(r){let e=["claude","opencode","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function wt(r,e){return{customTitle:r,platformSource:e?D(e):void 0}}var H=class{db;constructor(e=Te){e!==":memory:"&&Se(N),this.db=new Ae.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns()}initializeSchema(){this.db.run(`
    ...
    `,n=[];return t&&(s+=" AND COALESCE(platform_source, ?) = ?",n.push(h,t)),s+=" ORDER BY project ASC",this.db.prepare(s).all(...n).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
      ...
      FROM sdk_sessions
      WHERE project IS NOT NULL AND project != '' AND project != '${fe}'
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}saveNextUserPromptAtomic(e,t){let n=this.getLatestUserPrompt(e);return n&&n.prompt_text===t&&Date.now()-n.created_at_epoch<2e3?(u.debug("DEDUP","Skipped duplicate user_prompt (same text within window)",{contentSessionId:e,promptNumber:n.prompt_number}),{id:n.id,promptNumber:n.prompt_number,created_at_epoch:n.created_at_epoch,duplicateSkipped:!0}):this.db.transaction(()=>{let a=this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),_=new Date(d).toISOString(),m=P(e,s.title,s.narrative),l=X(this.db,m,d);if(l)return{id:l.id,createdAtEpoch:l.created_at_epoch};let T=this.db.prepare(`
...
`}function _t(r,e,t,s){let n=[];return s?n.push(...ze(r)):n.push(...we(r)),s?n.push(...Qe()):n.push(...Fe()),s?n.push(...Ze()):n.push(...Pe()),s?n.push(...et()):n.push(...Xe()),B(t)&&(s?n.push(...tt(e,t)):n.push(...He(e,t))),n}var de=M(require("path"),1);function q(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return u.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function ce(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function _e(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function mt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function ut(r,e){return de.default.isAbsolute(r)?de.default.relative(e,r):r}function pt(r,e,t){let s=q(r);if(s.length>0)return ut(s[0],e);if(t){let n=q(t);if(n.length>0)return ut(n[0],e)}return"General"}function jt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=mt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function lt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?q(r.facts).join(`
`):null}function Gt(r,e,t,s){let n=[];n.push(...je(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=ce(a.displayTime);n.push(...Ye(a,d))}else{let a=i.data,d=_e(a.created_at),m=d!==o?d:"";if(o=d,t.has(a.id)){let E=lt(a,s);n.push(...We(a,m,E,s))}else n.push(Be(a,m,s))}return n}function Bt(r,e,t,s,n){let o=[];o.push(...st(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let _=d.data,m=ce(_.displayTime);o.push(...it(_,m))}else{let _=d.data,m=pt(_.files_modified,n,_.files_read),l=_e(_.created_at),E=l!==a;a=l;let T=t.has(_.id);if(m!==i&&(o.push(...rt(m)),i=m),T){let O=lt(_,s);o.push(...ot(_,l,E,O,s))}else o.push(nt(_,l,E,s))}return o.push(""),o}function Wt(r,e,t,s,n,o){return o?Bt(r,e,t,s,n):Gt(r,e,t,s)}function Et(r,e,t,s,n){let o=[],i=jt(r);for(let[a,d]of i)o.push(...Wt(a,d,e,t,s,n));return o}function gt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Tt(r,e){let t=[];return e?(t.push(...$("Investigated",r.investigated,c.blue)),t.push(...$("Learned",r.learned,c.yellow)),t.push(...$("Completed",r.completed,c.green)),t.push(...$("Next Steps",r.next_steps,c.magenta))):(t.push(...k("Investigated",r.investigated)),t.push(...k("Learned",r.learned)),t.push(...k("Completed",r.completed)),t.push(...k("Next Steps",r.next_steps))),t}function ft(r,e){return e?at(r):Ve(r)}function St(r,e,t){return!B(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?dt(r.totalDiscoveryTokens,r.totalReadTokens):qe(r.totalDiscoveryTokens,r.totalReadTokens)}var Yt=bt.default.join((0,ht.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Vt(){try{return new H}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,Ot.unlinkSync)(Yt)}catch(e){u.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return u.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function qt(r,e){return e?ct(r):Ke(r)}function Kt(r,e,t,s,n,o,i){let a=[],d=re(e);a.push(..._t(r,d,s,i));let _=t.slice(0,s.sessionCount),m=xe(_,t),l=ae(e,m),E=ke(e,s.fullObservationCount);a.push(...Et(l,E,s,n,i));let T=t[0],O=e[0];gt(s,T,O)&&a.push(...Tt(T,i));let S=ie(e,s,o,n);return a.push(...ft(S,i)),a.push(...St(d,s,i)),a.join(`
`).trimEnd()}async function ue(r,e=!1){let t=ee(),s=r?.cwd??process.cwd(),n=Ce(s),o=r?.platform_source,i=r?.projects||[n];r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=Vt();if(!a)return"";try{let d=i.length>1?ve(a,i,t,o):ne(a,n,t,o),_=i.length>1?Ue(a,i,t,o):oe(a,n,t,o);return d.length===0&&_.length===0?qt(n,e):Kt(n,d,_,t,s,r?.session_id,e)}finally{a.close()}}0&&(module.exports={generateContext});
