"use strict";var Rt=Object.create;var F=Object.defineProperty;var Nt=Object.getOwnPropertyDescriptor;var Ct=Object.getOwnPropertyNames;var It=Object.getPrototypeOf,Lt=Object.prototype.hasOwnProperty;var Dt=(r,e)=>{for(var t in e)F(r,t,{get:e[t],enumerable:!0})},le=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Ct(e))!Lt.call(r,n)&&n!==t&&F(r,n,{get:()=>e[n],enumerable:!(s=Nt(e,n))||s.enumerable});return r};var y=(r,e,t)=>(t=r!=null?Rt(It(r)):{},le(e||!r||!r.__esModule?F(t,"default",{value:r,enumerable:!0}):t,r)),Mt=r=>le(F({},"__esModule",{value:!0}),r);var Jt={};Dt(Jt,{generateContext:()=>me});module.exports=Mt(Jt);var bt=y(require("path"),1),ht=require("os"),Ot=require("fs");var Ae=require("bun:sqlite");var f=require("path"),Q=require("os"),P=require("fs");var Te=require("url");var I=require("fs"),v=require("path"),ge=require("os"),J=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(J||{}),Ee=(0,v.join)((0,ge.homedir)(),".claude-mem"),z=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,v.join)(Ee,"logs");(0,I.existsSync)(e)||(0,I.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,v.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,v.join)(Ee,"settings.json");if((0,I.existsSync)(e)){let t=(0,I.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=J[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${a}.${d}`}log(e,t,s,n,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=J[e].padEnd(5),d=t.padEnd(6),_="";n?.correlationId?_=`[${n.correlationId}] `:n?.sessionId&&(_=`[session-${n.sessionId}] `);let m="";o!=null&&(o instanceof Error?m=this.getLevel()===0?`
${o.message}
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=_?`${_[1].split("/").pop()}:${_[2]}`:"unknown",l={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,l,n),o}},u=new z;var xt={};function yt(){return typeof __dirname<"u"?__dirname:(0,f.dirname)((0,Te.fileURLToPath)(xt.url))}var vt=yt();function Ut(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,f.join)((0,Q.homedir)(),".claude-mem"),e=(0,f.join)(r,"settings.json");try{if((0,P.existsSync)(e)){let{readFileSync:t}=require("fs"),s=JSON.parse(t(e,"utf-8")),n=s.env??s;if(n.CLAUDE_MEM_DATA_DIR)return n.CLAUDE_MEM_DATA_DIR}}catch{}return r}var N=Ut(),L=process.env.CLAUDE_CONFIG_DIR||(0,f.join)((0,Q.homedir)(),".claude"),ts=(0,f.join)(L,"plugins","marketplaces","thedotmack"),ss=(0,f.join)(N,"archives"),rs=(0,f.join)(N,"logs"),ns=(0,f.join)(N,"trash"),os=(0,f.join)(N,"backups"),is=(0,f.join)(N,"modes"),as=(0,f.join)(N,"settings.json"),fe=(0,f.join)(N,"claude-mem.db"),ds=(0,f.join)(N,"vector-db"),cs=(0,f.join)(N,"observer-sessions"),D="observer-sessions",_s=(0,f.join)(L,"settings.json"),us=(0,f.join)(L,"commands"),ms=(0,f.join)(L,"CLAUDE.md");function Se(r){(0,P.mkdirSync)(r,{recursive:!0})}function be(){return(0,f.join)(vt,"..")}var he=require("crypto");var kt=3e4;function H(r,e,t){return(0,he.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function j(r,e,t){let s=t-kt;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}function Z(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var h="claude";function $t(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function M(r){if(!r)return h;let e=$t(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("opencode")?"opencode":e.includes("claude")?"claude":e:h}function Oe(r){let e=["claude","opencode","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function wt(r,e){return{customTitle:r,platformSource:e?M(e):void 0}}var X=class{db;constructor(e=fe){e!==":memory:"&&Se(N),this.db=new Ae.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns()}initializeSchema(){this.db.run(`
    ...
    `,n=[];return t&&(s+=" AND COALESCE(platform_source, ?) = ?",n.push(h,t)),s+=" ORDER BY project ASC",this.db.prepare(s).all(...n).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
      ...
      FROM sdk_sessions
      WHERE project IS NOT NULL AND project != '' AND project != '${D}'
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=wt(n,o),_=d.platformSource??h,m=this.db.prepare(`
    ...
    `).get(e);if(m){if(t&&this.db.prepare(`
        ...
        `).run(d.customTitle,e),d.platformSource){let E=m.platform_source?.trim()?M(m.platform_source):void 0;if(!E)this.db.prepare(`
          ...
          `).run(d.platformSource,e);else if(E!==d.platformSource)throw new Error(`Platform source conflict for session ${e}: existing=${E}, received=${d.platformSource}`)}return m.id}if(t===D)throw u.warn("DB",`Blocked creation of observer-session record: ${e}`),new Error(`Refusing to create session with project="${D}"`);return this.db.prepare(`
      INSERT INTO sdk_sessions
      (content_session_id, memory_session_id, project, platform_source, user_prompt, custom_title, started_at, started_at_epoch, status)
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,t,_,s,d.customTitle||null,i.toISOString(),a),this.db.prepare("SELECT id FROM sdk_sessions WHERE content_session_id = ?").get(e).id}lookupSessionDbId(e){return this.db.prepare("SELECT id FROM sdk_sessions WHERE content_session_id = ?").get(e)?.id??null}pruneInternalRecords(){let t=this.db.prepare(`
      DELETE FROM user_prompts
      WHERE content_session_id IN (
        SELECT content_session_id FROM sdk_sessions
        WHERE project = ? OR project IS NULL OR project = ''
      )
    `).run(D).changes,n=this.db.prepare(`
      DELETE FROM sdk_sessions
      WHERE project = ? OR project IS NULL OR project = ''
    `).run(D).changes;return(n>0||t>0)&&u.info("DB",`Startup pruning: removed ${n} internal sessions, ${t} orphaned prompts`),{sessions:n,prompts:t}}saveUserPrompt(e,t,s){let n=new Date,o=n.getTime();return this.db.prepare(`
      INSERT INTO user_prompts
      (content_session_id, prompt_number, prompt_text, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?)
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}saveNextUserPromptAtomic(e,t){let n=this.getLatestUserPrompt(e);return n&&n.prompt_text===t&&Date.now()-n.created_at_epoch<2e3?(u.debug("DEDUP","Skipped duplicate user_prompt (same text within window)",{contentSessionId:e,promptNumber:n.prompt_number}),{id:n.id,promptNumber:n.prompt_number,created_at_epoch:n.created_at_epoch,duplicateSkipped:!0}):this.db.transaction(()=>{let a=this.db.prepare(`
        SELECT COUNT(*) as c FROM user_prompts WHERE content_session_id = ?
      `).get(e).c+1,d=new Date,_=d.getTime(),l=this.db.prepare(`
        INSERT INTO user_prompts
        (content_session_id, prompt_number, prompt_text, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?)
      `).run(e,a,t,d.toISOString(),_);return{id:Number(l.lastInsertRowid),promptNumber:a,created_at_epoch:_,duplicateSkipped:!1}})()}getUserPrompt(e,t){return this.db.prepare(`
      SELECT prompt_text
      FROM user_prompts
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(m.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let _=a??Date.now(),m=new Date(_).toISOString();return this.db.transaction(()=>{let E=[],T=this.db.prepare(`
      ...
      `);for(let S of s){let p=H(e,S.title,S.narrative),R=j(this.db,p,_);if(R){E.push(R.id);continue}let g=T.run(e,t,S.type,S.title,S.subtitle,JSON.stringify(S.facts),S.narrative,JSON.stringify(S.concepts),JSON.stringify(S.files_read),JSON.stringify(S.files_modified),o||null,i,p,m,_,d||null);E.push(Number(g.lastInsertRowid))}let O=null;if(n){let p=this.db.prepare(`
        ...
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         ...
         generated_by_model)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let g of s){let b=H(e,g.title,g.narrative),pe=j(this.db,b,l);if(pe){O.push(pe.id);continue}let At=S.run(e,t,g.type,g.title,g.subtitle,JSON.stringify(g.facts),g.narrative,JSON.stringify(g.concepts),JSON.stringify(g.files_read),JSON.stringify(g.files_modified),a||null,d,b,E,l,m||null);O.push(Number(At.lastInsertRowid))}let p;if(n){let b=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(e,...n,...i,...s?[s]:[],t.totalObservationCount)}function ie(r,e,t,s){return r.db.prepare(`
    SELECT
      ss.id,
    ...
    ORDER BY ss.created_at_epoch DESC
    LIMIT ?
  `).all(e,...s?[s]:[],t.sessionCount+se)}function ve(r,e,t,s){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),a=i.map(()=>"?").join(","),d=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id,
      o.memory_session_id,
      COALESCE(s.platform_source, 'claude') as platform_source,
...
`}function _t(r,e,t,s){let n=[];return s?n.push(...ze(r)):n.push(...we(r)),s?n.push(...Qe()):n.push(...Fe()),s?n.push(...Ze()):n.push(...Pe()),s?n.push(...et()):n.push(...He()),W(t)&&(s?n.push(...tt(e,t)):n.push(...je(e,t))),n}var ce=y(require("path"),1);function K(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return u.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function _e(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function ue(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function mt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function ut(r,e){return ce.default.isAbsolute(r)?ce.default.relative(e,r):r}function pt(r,e,t){let s=K(r);if(s.length>0)return ut(s[0],e);if(t){let n=K(t);if(n.length>0)return ut(n[0],e)}return"General"}function Xt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=mt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function lt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?K(r.facts).join(`
`):null}function Gt(r,e,t,s){let n=[];n.push(...Xe(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=_e(a.displayTime);n.push(...Ye(a,d))}else{let a=i.data,d=ue(a.created_at),m=d!==o?d:"";if(o=d,t.has(a.id)){let E=lt(a,s);n.push(...We(a,m,E,s))}else n.push(Be(a,m,s))}return n}function Bt(r,e,t,s,n){let o=[];o.push(...st(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let _=d.data,m=_e(_.displayTime);o.push(...it(_,m))}else{let _=d.data,m=pt(_.files_modified,n,_.files_read),l=ue(_.created_at),E=l!==a;a=l;let T=t.has(_.id);if(m!==i&&(o.push(...rt(m)),i=m),T){let O=lt(_,s);o.push(...ot(_,l,E,O,s))}else o.push(nt(_,l,E,s))}return o.push(""),o}function Wt(r,e,t,s,n,o){return o?Bt(r,e,t,s,n):Gt(r,e,t,s)}function Et(r,e,t,s,n){let o=[],i=Xt(r);for(let[a,d]of i)o.push(...Wt(a,d,e,t,s,n));return o}function gt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Tt(r,e){let t=[];return e?(t.push(...w("Investigated",r.investigated,c.blue)),t.push(...w("Learned",r.learned,c.yellow)),t.push(...w("Completed",r.completed,c.green)),t.push(...w("Next Steps",r.next_steps,c.magenta))):(t.push(...$("Investigated",r.investigated)),t.push(...$("Learned",r.learned)),t.push(...$("Completed",r.completed)),t.push(...$("Next Steps",r.next_steps))),t}function ft(r,e){return e?at(r):Ve(r)}function St(r,e,t){return!W(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?dt(r.totalDiscoveryTokens,r.totalReadTokens):qe(r.totalDiscoveryTokens,r.totalReadTokens)}var Yt=bt.default.join((0,ht.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Vt(){try{return new X}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,Ot.unlinkSync)(Yt)}catch(e){u.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return u.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function qt(r,e){return e?ct(r):Ke(r)}function Kt(r,e,t,s,n,o,i){let a=[],d=ne(e);a.push(..._t(r,d,s,i));let _=t.slice(0,s.sessionCount),m=xe(_,t),l=de(e,m),E=ke(e,s.fullObservationCount);a.push(...Et(l,E,s,n,i));let T=t[0],O=e[0];gt(s,T,O)&&a.push(...Tt(T,i));let S=ae(e,s,o,n);return a.push(...ft(S,i)),a.push(...St(d,s,i)),a.join(`
`).trimEnd()}async function me(r,e=!1){let t=te(),s=r?.cwd??process.cwd(),n=Ce(s),o=r?.platform_source,i=r?.projects||[n];r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=Vt();if(!a)return"";try{let d=i.length>1?ve(a,i,t,o):oe(a,n,t,o),_=i.length>1?Ue(a,i,t,o):ie(a,n,t,o);return d.length===0&&_.length===0?qt(n,e):Kt(n,d,_,t,s,r?.session_id,e)}finally{a.close()}}0&&(module.exports={generateContext});
